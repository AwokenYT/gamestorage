!function e(t, n, o) {
	function i(s, a) {
	  if (!n[s]) {
		if (!t[s]) {
		  ...
		  if (!a && d) return d(s, true);
		  if (r) return r(s, true);
	...
	(function (o, i) {
	  !function (e, o) {
		"object" == typeof n && undefined !== t ? t.exports = o() : "function" == typeof define && define.amd ? define(o) : e.ES6Promise = o();
	  }(this, function () {
		"use strict";
		function t(e) {
		  var t = typeof e;
		...
		function a() {
		  for (var e = 0; e < O; e += 2) (0, F[e])(F[e + 1]), F[e] = undefined, F[e + 1] = undefined;
		  O = 0;
		}
		function d(e, t) {
		  var n = this, o = new this.constructor(l);
		  undefined === o[Y] && I(o);
		  var i = n._state;
		  if (i) {
			var r = arguments[i - 1];
		...
		function f(e, t, n) {
		  N(function (e) {
			var o = false, i = p(n, t, function (n) {
			  o || (o = true, t !== n ? y(e, n) : _(e, n));
			}, function (t) {
			  o || (o = true, E(e, t));
		...
		function m(e, t) {
		  t._state === Q ? _(e, t._result) : t._state === V ? E(e, t._result) : w(t, undefined, function (t) {
			return y(e, t);
		  }, function (t) {
			return E(e, t);
		  });
		...
		function v(e, t, o) {
		  t.constructor === e.constructor && o === d && t.constructor.resolve === c ? m(e, t) : o === W ? (E(e, W.error), W.error = null) : undefined === o ? _(e, t) : "function" == typeof o ? f(e, t, o) : _(e, t);
		}
		function y(e, n) {
		...
		function A(e) {
		  ...
		  if (0 !== t.length) {
			for (var o = undefined, i = undefined, r = e._result, s = 0; s < t.length; s += 3) o = t[s], i = t[s + n], o ? T(n, o, i, r) : i(r);
		...
		function T(e, t, o, i) {
		  var r = "function" == typeof o, s = undefined, a = undefined, d = undefined, c = undefined;
		  if (r) {
			if ((s = D(o, i)) === W ? (c = true, a = s.error, s.error = null) : d = true, t === s) return void E(t, h());
		  } else s = i, d = true;
		...
		function I(e) {
		  e[Y] = X++, e._state = undefined, e._result = undefined, e._subscribers = [];
		}
		function C() {
		...
		var L = undefined, P = L = Array.isArray ? Array.isArray : function (e) {
		  return "[object Array]" === Object.prototype.toString.call(e);
		}, O = 0, B = undefined, M = undefined, N = function (e, t) {
		  F[O] = e, F[O + 1] = t, 2 === (O += 2) && (M ? M(a) : q());
		}, U = "undefined" != typeof window ? window : undefined, G = U || {}, K = G.MutationObserver || G.WebKitMutationObserver, j = "undefined" == typeof self && undefined !== o && "[object process]" === {}.toString.call(o), H = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel, F = new Array(1e3), q = undefined;
		q = j ? function () {
		  return o.nextTick(a);
		} : K ? function () {
		  var e = 0, t = new K(a), n = document.createTextNode("");
		  return t.observe(n, {characterData: true}), function () {
			n.data = e = ++e % 2;
		  };
		}() : H ? function () {
		...
		}() : undefined === U && "function" == typeof e ? function () {
		  try {
		...
		var Y = Math.random().toString(36).substring(2), z = undefined, Q = 1, V = 2, W = {error: null}, X = 0, J = function () {
		  function e(e, t) {
		  ...
		  return e.prototype._enumerate = function (e) {
			...
			if (o === c) {
			  var i = g(e);
			  if (i === d && e._state !== z) this._settledAt(e._state, t, e._result); else if ("function" != typeof i) this._remaining--, this._result[t] = e; else if (n === Z) {
				var r = new n(l);
		  ...
		  function e(t) {
			this[Y] = R(), this._result = this._state = undefined, this._subscribers = [], l !== t && ("function" != typeof t && k(), this instanceof e ? S(this, t) : x());
		  }
		...
		return Z.prototype.then = d, Z.all = function (e) {
		  ...
		  var e = undefined;
		  if (undefined !== i) e = i; else if ("undefined" != typeof self) e = self; else try {
	...
	function a() {
	  m && p && (m = false, p.length ? f = p.concat(f) : v = -1, f.length && d());
	}
	function d() {
	  if (!m) {
		var e = r(a);
	...
	}, g.title = "browser", g.browser = true, g.env = {}, g.argv = [], g.version = "", g.versions = {}, g.on = l, g.addListener = l, g.once = l, g.off = l, g.removeListener = l, g.removeAllListeners = l, g.emit = l, g.prependListener = l, g.prependOnceListener = l, g.listeners = function (e) {
	  return [];
	...
	!function (e) {
	  ...
	  function u() {
		return this.bodyUsed = false, this._initBody = function (e) {
		  if (this._bodyInit = e, e) if ("string" == typeof e) this._bodyText = e; else if (v.blob && Blob.prototype.isPrototypeOf(e)) this._bodyBlob = e; else if (v.formData && FormData.prototype.isPrototypeOf(e)) this._bodyFormData = e; else if (v.searchParams && URLSearchParams.prototype.isPrototypeOf(e)) this._bodyText = e.toString(); else if (v.arrayBuffer && v.blob && b(e)) this._bodyArrayBuffer = l(e.buffer), this._bodyInit = new Blob([this._bodyArrayBuffer]); else {
	  ...
	  function g(e, t) {
		...
		if (e instanceof g) {
		  ...
		  this.url = e.url, this.credentials = e.credentials, t.headers || (this.headers = new i(e.headers)), this.method = e.method, this.mode = e.mode, n || null == e._bodyInit || (n = e._bodyInit, e.bodyUsed = true);
	  ...
	  function p(e) {
		...
		return e.trim().split("&").forEach(function (e) {
		  if (e) {
			var n = e.split("="), o = n.shift().replace(/\+/g, " "), i = n.join("=").replace(/\+/g, " ");
	  ...
	  if (!e.fetch) {
		...
		if (v.arrayBuffer) var y = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]"], _ = ArrayBuffer.isView || function (e) {
		  return e && y.indexOf(Object.prototype.toString.call(e)) > -1;
		};
		i.prototype.append = function (e, o) {
		  e = t(e), o = ("string" != typeof o && (o = String(o)), o);
		  var i = this.map[e];
		  this.map[e] = i ? i + "," + o : o;
		  ...
		  this.map[t(e)] = ("string" != typeof o && (o = String(o)), o);
		...
		g.prototype.clone = function () {
		  ...
		  return new m(this._bodyInit, {status: this.status, statusText: this.statusText, headers: new i(this.headers), url: this.url});
		}, m.error = function () {
	...
	var i = function () {
	  ...
	  return i(e, [{key: "_getListenerIdx", value: function (e, t, n) {
		var o = this.listeners[e], i = undefined, r = -1;
		if (!o || 0 === o.length) return r;
		for (i = 0; i < o.length; i++) if (o[i].callback === t && (!n || n === o[i].scope)) {
		  r = i;
		  break;
		}
		return r;
		...
		this._getListenerIdx(e, t, n) >= 0 || (o = {callback: t, scope: n}, this.listeners[e] = this.listeners[e] || [], this.listeners[e].push(o));
	...
	var i = function () {
	...
	}(e("../components/EventBus")), s = null, a = function () {
	  function e(t) {
	  ...
	  return i(e, [{key: "start", value: function () {
		...
		var o = document.body || document.getElementsByTagName("body")[0], i = document.createElement("div");
	...
	n.default = a;
  }, {"../components/EventBus": 6}], 8: [function (e, t, n) {
	"use strict";
	function o(e, t) {
	  if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
	}
	...
	var i = function () {
	  ...
	  return e && e.__esModule ? e : {default: e};
	}(e("../components/EventBus")), s = e("../modules/common"), a = e("../modules/dankLog"), d = null, c = function () {
	  function e(t, n, i) {
		var a = this;
		if (o(this, e), d) return d;
		d = this;
		var c = {debug: false, width: 640, height: 360, locale: "en"};
		this.options = i ? (0, s.extendDefaults)(c, i) : c, this.prefix = "gdsdk__", this.adsLoader = null, this.adsManager = null, this.adDisplayContainer = null, this.eventBus = new r.default, this.safetyTimer = null, this.containerTransitionSpeed = 300, this.adCount = 0, this.adTypeCount = 0, this.requestRunning = false, this.parentDomain = (0, s.getParentDomain)(), this.parentUrl = (0, s.getParentUrl)(), this.userDeclinedPersonalAds = document.location.search.indexOf("gdpr-targeting=0") >= 0 || document.cookie.indexOf("ogdpr_advertisement=0") >= 0 ? "1" : "0", this.thirdPartyContainer = "" !== t ? document.getElementById(t) : null, this.options.width = "number" == typeof this.options.width ? this.options.width : "100%" === this.options.width ? 640 : this.options.width.replace(/[^0-9]/g, ""), this.options.height = "number" == typeof this.options.height ? this.options.height : "100%" === this.options.height ? 360 : this.options.height.replace(/[^0-9]/g, "");
		var l = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth, u = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight;
		this.options.width = this.thirdPartyContainer ? this.thirdPartyContainer.offsetWidth : l, this.options.height = this.thirdPartyContainer ? this.thirdPartyContainer.offsetHeight : u, this.gameId = "0", this.category = "", this.tags = [], this.eventCategory = "AD", this.adsLoaderPromise = new Promise(function (e, t) {
	  ...
	  return i(e, [{key: "start", value: function () {
		...
		var e = this;
		return new Promise(function (t, n) {
		  if (e.requestRunning) (0, a.dankLog)("AD_SDK_REQUEST", "A request is already running", "warning"); else {
			...
			try {
			  localStorage.getItem("gd_debug") && localStorage.getItem("gd_tag") ? t(localStorage.getItem("gd_tag")) : e._tunnlReportingKeys().then(function (o) {
				undefined === window.idhbgd.requestAds && n("Prebid.js wrapper script hit an error or didn't exist!");
				var i = (o.nsid ? o.nsid : "TNL_T-17102571517") + "/" + (o.tid ? o.tid : "TNL_NS-18101700058");
				delete o.nsid, delete o.tid, (0, a.dankLog)("AD_SDK_AD_UNIT", i, "info");
				var r = o.consent_string ? o.consent_string : "BOWJjG9OWJjG9CLAAAENBx-AAAAiDAAA";
				Object.assign(o, {tnl_system: "1", tnl_content_category: e.category.toLowerCase()}), undefined !== window.ga && window.ga("gd.send", {hitType: "event", eventCategory: "AD_REQUEST", eventAction: e.parentDomain, eventLabel: i});
				var s = "0" === e.userDeclinedPersonalAds;
				window.idhbgd.que.push(function () {
				  window.idhbgd.setAdserverTargeting(o), window.idhbgd.setDfpAdUnitCode(i), window.idhbgd.setRefererUrl(encodeURIComponent(e.parentUrl)), window.idhbgd.allowPersonalizedAds(s), window.idhbgd.setDefaultGdprConsentString(r), window.idhbgd.requestAds({callback: function (e) {
					t(e);
				  }});
				});
			  }).catch(function (e) {
		...
		return new Promise(function (t) {
		  ...
		  fetch(u).then(function (e) {
			...
			console.log(n);
			var o = {tid: "TNL_T-17102571517", nsid: "TNL_NS-18101700058", tnl_tid: "T-17102571517", tnl_nsid: "NS-18101700058", tnl_pw: e.options.width, tnl_ph: e.options.height, tnl_pt: "22", tnl_pid: "P-17101800031", tnl_paid: "17", tnl_ad_type: "video_image", tnl_asset_id: e.gameId.toString(), tnl_ad_pos: i, tnl_skippable: "1", tnl_cp1: "", tnl_cp2: "", tnl_cp3: "", tnl_cp4: "", tnl_cp5: "", tnl_cp6: "", tnl_campaign: "2", tnl_gdpr: "0", tnl_gdpr_consent: "1", consent_string: "BOWJjG9OWJjG9CLAAAENBx-AAAAiDAAA", tnl_content_category: e.category.toLowerCase()};
			undefined !== window.ga && window.ga("gd.send", {hitType: "event", eventCategory: "AD_REQUEST_FALLBACK", eventAction: e.parentUrl, eventLabel: n}), t(o);
		  });
		});
	  }}, {key: "loadAd", value: function (e) {
		if ("undefined" != typeof google) try {
		  var t = new google.ima.AdsRequest;
		  if (t.adTagUrl = e, (0, a.dankLog)("AD_SDK_TAG_URL", t.adTagUrl, "success"), t.linearAdSlotWidth = this.options.width, t.linearAdSlotHeight = this.options.height, t.nonLinearAdSlotWidth = this.options.width, t.nonLinearAdSlotHeight = this.options.height, t.forceNonLinearFullSlot = true, undefined !== window.ga) {
			var n = new Date, o = n.getHours(), i = n.getDate(), r = n.getMonth(), s = n.getFullYear();
			window.ga("gd.send", {hitType: "event", eventCategory: 1 === this.adTypeCount ? "AD_PREROLL" : "AD_MIDROLL", eventAction: this.parentDomain + " | h" + o + " d" + i + " m" + r + " y" + s, eventLabel: e});
		  }
		...
		this.eventBus.broadcast("AD_CANCELED", {name: "AD_CANCELED", message: "Advertisement has been canceled.", status: "warning", analytics: {category: this.eventCategory, action: "AD_CANCELED", label: this.gameId}});
	  }}, {key: "onError", value: function (e) {
		this.eventBus.broadcast("AD_SDK_ERROR", {name: "AD_SDK_ERROR", message: e, status: "error", analytics: {category: this.eventCategory, action: "AD_SDK_ERROR", label: e}}), this.cancel(), this._clearSafetyTimer("AD_SDK_ERROR");
		...
		var e = this, t = new Promise(function (t, n) {
		  var o = e.options.debug ? "//imasdk.googleapis.com/js/sdkloader/ima3_debug.js" : "//imasdk.googleapis.com/js/sdkloader/ima3.js", i = document.getElementsByTagName("script")[0], r = document.createElement("script");
		  r.type = "text/javascript", r.async = true, r.src = o, r.onload = function () {
			t();
		  }, r.onerror = function () {
			n("IMA script failed to load! Probably due to an ADBLOCKER!");
		  }, i.parentNode.insertBefore(r, i);
		}), n = new Promise(function (t, n) {
		  var o = e.options.debug ? "https://test-hb.improvedigital.com/pbw/gameDistribution.min.js?v=1" : "https://hb.improvedigital.com/pbw/gameDistribution.min.js?v=1", i = document.getElementsByTagName("script")[0], r = document.createElement("script");
		  r.type = "text/javascript", r.id = "idhbgd", r.async = true, r.src = o, r.onload = function () {
			t();
		  }, r.onerror = function () {
		...
		n.id = this.prefix + "advertisement_slot", n.style.position = "absolute", n.style.backgroundColor = "#000000", n.style.top = "0", n.style.left = "0", n.style.width = this.options.width + "px", n.style.height = this.options.height + "px", this.thirdPartyContainer ? (this.adContainer.appendChild(n), this.thirdPartyContainer.appendChild(this.adContainer)) : (this.adContainer.appendChild(n), t.appendChild(this.adContainer)), window.addEventListener("resize", function () {
		  var t = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth, o = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight;
		...
		var t = this, n = new Date, o = n.getHours(), i = n.getDate(), r = n.getMonth(), s = n.getFullYear(), a = "", d = "";
		switch (e.type) {
		  ...
		  case google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED:
			a = "CONTENT_RESUME_REQUESTED", d = "Fired when content should be resumed. This usually happens when an ad finishes or collapses.", this._hide(), this.adsLoaderPromise.then(function () {
			  ...
			  t.eventBus.broadcast("AD_SDK_FINISHED", {name: "AD_SDK_FINISHED", message: "IMA is ready for new requests.", status: "success", analytics: {category: "AD_SDK_FINISHED", action: t.parentDomain, label: "h" + o + " d" + i + " m" + r + " y" + s}});
			}).catch(function () {
			  console.log(new Error("adsLoaderPromise failed to load."));
			});
			break;
		  ...
		  case google.ima.AdEvent.Type.IMPRESSION:
			...
			try {
			  if (undefined !== window.pbjsgd) {
				var c = window.pbjsgd.getHighestCpmBids();
				this.options.debug && console.log("Winner(s)", c), c.length > 0 ? c.forEach(function (e) {
				  undefined !== window.ga && e.bidder && window.ga("gd.send", {hitType: "event", eventCategory: "IMPRESSION_" + e.bidder.toUpperCase(), eventAction: t.parentDomain, eventLabel: "h" + o + " d" + i + " m" + r + " y" + s});
				}) : undefined !== window.ga && window.ga("gd.send", {hitType: "event", eventCategory: "IMPRESSION_ADEXCHANGE", eventAction: this.parentDomain, eventLabel: "h" + o + " d" + i + " m" + r + " y" + s});
			  }
			} catch (e) {
			  console.log(e);
			}
		...
		"" !== a && "" !== d && this.eventBus.broadcast(a, {name: a, message: d, status: "success", analytics: {category: a, action: this.parentDomain, label: "h" + o + " d" + i + " m" + r + " y" + s}});
		...
		try {
		  if (undefined !== window.ga) {
			...
			this.eventBus.broadcast("AD_ERROR", {name: "AD_ERROR", message: t, status: "warning", analytics: {category: "AD_ERROR", action: e.getError().getErrorCode().toString() || e.getError().getVastErrorCode().toString(), label: t}});
		  }
		  if (undefined !== window.pbjsgd) {
			...
			this.options.debug && console.log("Failed winner(s) ", n), n.length > 0 ? n.forEach(function (t) {
			  ...
			  undefined !== window.ga && t.bidder && window.ga("gd.send", {hitType: "event", eventCategory: "AD_ERROR_" + t.bidder.toUpperCase(), eventAction: e.getError().getErrorCode().toString() || e.getError().getVastErrorCode().toString(), eventLabel: n + " | " + o});
			}) : undefined !== window.ga && window.ga("gd.send", {hitType: "event", eventCategory: "AD_ERROR_ADEXCHANGE", eventAction: e.getError().getErrorCode().toString() || e.getError().getVastErrorCode().toString(), eventLabel: e.getError().getMessage()});
		  }
		} catch (e) {
		  console.log(e);
		}
		...
		(0, a.dankLog)("AD_SAFETY_TIMER", "Invoked timer from: " + t, "success"), this.safetyTimer = window.setTimeout(function () {
		  n.eventBus.broadcast("AD_SAFETY_TIMER", {name: "AD_SAFETY_TIMER", message: "Advertisement took too long to load.", status: "warning", analytics: {category: n.eventCategory, action: "AD_SAFETY_TIMER", label: n.gameId}}), n.cancel(), n._clearSafetyTimer(t);
		}, e);
	  }}, {key: "_clearSafetyTimer", value: function (e) {
		if (undefined !== this.safetyTimer && null !== this.safetyTimer && ((0, a.dankLog)("AD_SAFETY_TIMER", "Cleared timer set at: " + e, "success"), clearTimeout(this.safetyTimer), this.safetyTimer = undefined, "requestAd()" === e)) {
		  var t = new Date, n = t.getHours(), o = t.getDate(), i = t.getMonth(), r = t.getFullYear();
		  undefined !== window.ga && window.ga("gd.send", {hitType: "event", eventCategory: "AD_SDK_AD_REQUEST_ERROR", eventAction: "h" + n + " d" + o + " m" + i + " y" + r});
		}
	  }}, {key: "_loadDisplayAd", value: function (e, t, n) {
		var o = this, i = document.body || document.getElementsByTagName("body")[0], r = document.createElement("div");
		...
		d.parentNode.insertBefore(s, d), window.googletag = window.googletag || {}, window.googletag.cmd = window.googletag.cmd || [], googletag.cmd.push(function () {
		  var i = [];
		  i[0] = googletag.defineSlot("/1015413/Gamedistribution_ingame_1x1_crosspromo", [1, 1], o.prefix + "baguette").setCollapseEmptyDiv(true, true).addService(googletag.pubads()), googletag.pubads().setTargeting("crossid", e), googletag.pubads().setTargeting("crosstags", t), googletag.pubads().setTargeting("crosscategory", n), googletag.pubads().disableInitialLoad(), googletag.enableServices(), googletag.display(o.prefix + "baguette"), googletag.pubads().refresh([i[0]]);
		});
	  }}]), e;
	}();
	n.default = c;
  }, {"../components/EventBus": 6, "../modules/common": 11, "../modules/dankLog": 12}], 9: [function (e, t, n) {
	"use strict";
	var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
	  ...
	  return e && e.__esModule ? e : {default: e};
	}(e("./main")), r = "object" === ("undefined" == typeof GD_OPTIONS ? "undefined" : o(GD_OPTIONS)) && GD_OPTIONS ? GD_OPTIONS : window.gdApi && "object" === o(window.gdApi.q[0][0]) && window.gdApi.q[0][0] ? window.gdApi.q[0][0] : {};
	window.gdApi && "object" === o(window.gdApi.q[0][0]) && window.gdApi.q[0][0] && (r.hasOwnProperty("advertisementSettings") || (r.advertisementSettings = {autoplay: true})), window.gdsdk = new i.default(r), window.gdApi = window.gdsdk;
  }, {"./main": 10}], 10: [function (e, t, n) {
	"use strict";
	function o(e) {
	  return e && e.__esModule ? e : {default: e};
	}
	...
	var a = o(e("../package.json")), d = o(e("./components/VideoAd")), c = o(e("./components/EventBus")), l = o(e("./components/ImplementationTest")), u = e("./modules/dankLog"), h = e("./modules/common"), g = null, p = function () {
	  function e(t) {
		var n = this;
		if (i(this, e), g) return g;
		g = this;
		var o = {debug: false, testing: false, gameId: "4f3d7d38d24b740c95da2b03dc3a2333", prefix: "gdsdk__", flashSettings: {adContainerId: "", splashContainerId: ""}, advertisementSettings: {}, resumeGame: function () {}, pauseGame: function () {}, onEvent: function (e) {}, onInit: function (e) {}, onError: function (e) {}};
		this.options = t ? (0, h.extendDefaults)(o, t) : o;
		var r = a.default.version, s = console.log("%c %c %c GameDistribution.com HTML5 SDK | Version: " + r + " %c %c %c", "background: #9854d8", "background: #6c2ca7", "color: #fff; background: #450f78;", "background: #6c2ca7", "background: #9854d8", "background: #ffffff");
		console.log.apply(console, s);
		var m = [];
		this.options.testing = this.options.testing || m.indexOf(p) > -1, this.options.testing && (0, u.dankLog)("SDK_TESTING_ENABLED", this.options.testing, "info"), this.whitelabelPartner = false;
		var v = (0, h.getQueryParams)("xanthophyll");
		v.hasOwnProperty("xanthophyll") && "true" === v.xanthophyll && (this.whitelabelPartner = true, (0, u.dankLog)("SDK_WHITELABEL", this.whitelabelPartner, "success"));
		try {
		...
		(new Image).src = "https://ana.tunnl.com/event?page_url=" + encodeURIComponent(l) + "&game_id=" + this.options.gameId + "&eventtype=1", this.eventBus = new c.default, this.eventBus.gameId = this.options.gameId + "", this.eventBus.subscribe("SDK_BLOCKED", function (e) {
		  return n._onEvent(e);
		  ...
		  if (n._onEvent(e), n.onResumeGame("Advertisement(s) are done. Start / resume the game.", "success"), "developer.gamedistribution.com" === p || true === new RegExp("^localhost").test(p)) {
		  ...
		  return n._onEvent(e);
		}), this._gdpr(p), this.adRequestTimer = undefined, this.videoAdInstance = new d.default(this.options.flashSettings.adContainerId, this.options.prefix, this.options.advertisementSettings);
		var y = new Promise(function (e) {
		  var t = {gameId: n.options.gameId ? n.options.gameId + "" : "49258a0e497c42b5b5d87887f24d27a6", advertisements: true, preroll: true, midroll: 12e4, title: "", tags: [], category: "", assets: []}, o = "https://game.api.gamedistribution.com/game/get/" + t.gameId.replace(/-/g, "") + "/?domain=" + p, i = new Request(o, {method: "GET"});
		  fetch(i).then(function (e) {
			var t = e.headers.get("content-type");
			if (t && -1 !== t.indexOf("application/json")) return e.json();
			throw new TypeError("Oops, we didn't get JSON!");
		  }).then(function (n) {
			if (n.error) (0, u.dankLog)("SDK_GAME_DATA_READY", n.error, "warning"); else if (n.success) {
			  var o = {gameId: n.result.game.gameMd5, advertisements: n.result.game.enableAds, preroll: n.result.game.preRoll, midroll: 6e4 * n.result.game.timeAds, title: n.result.game.title, tags: n.result.game.tags, category: n.result.game.category, assets: n.result.game.assets};
			  t = (0, h.extendDefaults)(t, o);
			  var i = ["patiencespel.net", "mahjongspielen.at", "mahjongspel.co"];
			  ["y8.com", "pog.com", "dollmania.com"].indexOf(p) > -1 ? t.midroll = 3e5 : i.indexOf(p) > -1 && (t.midroll = 6e4), ["happygames.io", "happygames-dev.gamedistribution.com"].indexOf(p) > -1 && (t.preroll = false), (0, u.dankLog)("SDK_GAME_DATA_READY", t, "success");
			}
			e(t);
		  }).catch(function (n) {
			(0, u.dankLog)("SDK_GAME_DATA_READY", n, "success"), e(t);
		  });
		});
		y.then(function (e) {
		  ...
		  return n.eventBus.broadcast("SDK_READY", {name: "SDK_READY", message: "Everything is ready.", status: "success", analytics: {category: "SDK", action: "SDK_READY", label: n.options.gameId + ""}}), n.options.onInit("Everything is ready."), e[0];
		}).catch(function () {
		  return n.eventBus.broadcast("SDK_ERROR", {name: "SDK_ERROR", message: "The SDK failed.", status: "error", analytics: {category: "SDK", action: "SDK_ERROR", label: n.options.gameId + ""}}), n.options.onError("The SDK failed."), false;
		});
	  }
	  return s(e, [{key: "_gdpr", value: function (e) {
		var t = document.location.search.indexOf("gdpr-tracking") >= 0, n = document.location.search.indexOf("gdpr-tracking=1") >= 0, o = "", i = "";
		t ? n ? (o = "General Data Protection Regulation is set to allow tracking.", i = "success") : (o = "General Data Protection Regulation is set to disallow tracking.", i = "warning") : (o = "General Data Protection Regulation consent for tracking is not set by the publisher.", i = "warning"), this.eventBus.broadcast("SDK_GDPR_TRACKING", {name: "SDK_GDPR_TRACKING", message: o, status: i, analytics: {category: "SDK_GDPR_TRACKING", action: e, label: t ? n ? "1" : "0" : "not set"}});
		var r = document.location.search.indexOf("gdpr-targeting") >= 0, s = document.location.search.indexOf("gdpr-targeting=1") >= 0, a = "", d = "";
		r ? s ? (a = "General Data Protection Regulation is set to allow personalised advertisements.", d = "success") : (a = "General Data Protection Regulation is set to disallow personalised advertisements.", d = "warning") : (a = "General Data Protection Regulation consent for targeting is not set by the publisher.", d = "warning"), this.eventBus.broadcast("SDK_GDPR_TARGETING", {name: "SDK_GDPR_TARGETING", message: a, status: d, analytics: {category: "SDK_GDPR_TARGETING", action: e, label: r ? s ? "1" : "0" : "not set"}});
		var c = document.location.search.indexOf("gdpr-third-party") >= 0, l = document.location.search.indexOf("gdpr-third-party=1") >= 0, u = "", h = "";
		c ? l ? (u = "General Data Protection Regulation is set to allow third parties.", h = "success") : (u = "General Data Protection Regulation is set to disallow third parties.", h = "warning") : (u = "General Data Protection Regulation consent for third parties is not set by the publisher.", h = "warning"), this.eventBus.broadcast("SDK_GDPR_THIRD_PARTY", {name: "SDK_GDPR_THIRD_PARTY", message: u, status: h, analytics: {category: "SDK_GDPR_THIRD_PARTY", action: e, label: c ? l ? "1" : "0" : "not set"}});
	  }}, {key: "_onEvent", value: function (e) {
		(0, u.dankLog)(e.name, e.message, e.status);
		try {
		  undefined !== window.ga && e.analytics && window.ga("gd.send", {hitType: "event", eventCategory: e.analytics.category ? e.analytics.category : "", eventAction: e.analytics.action ? e.analytics.action : "", eventLabel: e.analytics.label ? e.analytics.label : ""});
		} catch (e) {
		  console.log(e);
		}
		...
		var n = this;
		(0, h.getScript)("https://www.google-analytics.com/analytics.js", "gdsdk_google_analytics").then(function () {
		  window.ga("create", "UA-102601800-1", {name: "gd", cookieExpires: 7776e3}, "auto"), window.ga("gd.send", "pageview"), e || window.ga("gd.set", "anonymizeIp", true);
		}).catch(function (e) {
		  (0, u.dankLog)("SDK_LOAD_SCRIPT", e, "error");
		}), e || (0, h.getScript)("https://tags.crwdcntrl.net/c/13998/cc.js?ns=_cc13998", "LOTCC_13998").then(function () {
		  n.readyPromise.then(function (e) {
			"object" === r(window._cc13998) && "function" == typeof window._cc13998.bcpf && "function" == typeof window._cc13998.bcpw && (window._cc13998.bcpw("act", "play"), window._cc13998.bcpw("int", "domain : " + t), window._cc13998.bcpw("int", "category : " + e.category.toLowerCase()), "complete" === document.readyState ? window._cc13998.bcpf() : window._cc13998.bcp());
		  });
		}).catch(function (e) {
		  (0, u.dankLog)("SDK_LOAD_SCRIPT", e, "error");
		});
		...
		this.readyPromise.then(function (t) {
		  t.advertisements && !e.whitelabelPartner ? undefined !== e.adRequestTimer ? (new Date).valueOf() - e.adRequestTimer.valueOf() < t.midroll ? ((0, u.dankLog)("SDK_SHOW_BANNER", "The advertisement was requested too soon after the previous advertisement was finished.", "warning"), e.onResumeGame("Just resume the game...", "success")) : ((0, u.dankLog)("SDK_SHOW_BANNER", "Requested the midroll advertisement.", "success"), e.adRequestTimer = new Date, e.videoAdInstance.requestAttempts = 0, e.videoAdInstance.requestAd().then(function (t) {
	  ...
	  }}, {key: "customLog", value: function (e) {}}, {key: "play", value: function () {}}, {key: "onResumeGame", value: function (e, t) {
		try {
		  this.options.resumeGame();
		} catch (e) {
		  console.log(e);
		}
		this.eventBus.broadcast("SDK_GAME_START", {name: "SDK_GAME_START", message: e, status: t, analytics: {category: "SDK", action: "SDK_GAME_START", label: this.options.gameId + ""}});
		...
		this.eventBus.broadcast("SDK_GAME_PAUSE", {name: "SDK_GAME_PAUSE", message: e, status: t, analytics: {category: "SDK", action: "SDK_GAME_PAUSE", label: this.options.gameId + ""}});
	  }}, {key: "openConsole", value: function () {
		try {
		  new l.default(this.options.testing).start(), localStorage.setItem("gd_debug", true);
		} catch (e) {
		  console.log(e);
		}
	  }}]), e;
	...
	n.default = p;
  }, {"../package.json": 5, "./components/EventBus": 6, "./components/ImplementationTest": 7, "./components/VideoAd": 8, "./modules/common": 11, "./modules/dankLog": 12, "es6-promise/auto": 1, "whatwg-fetch": 4}], 11: [function (e, t, n) {
	"use strict";
	function o(e, t) {
	...
	function i() {
	  for (var e = undefined, t = /\+/g, n = /([^&=]+)=?([^&]*)/g, i = window.location.search.substring(1), r = {}; e = n.exec(i);) r[decodeURIComponent(e[1].toLowerCase().replace(t, " "))] = decodeURIComponent(e[2].toLowerCase().replace(t, " "));
	  return r;
	}
	function s(e) {
	  for (; (e = e || "") !== decodeURIComponent(e);) e = decodeURIComponent(e);
	  return e;
	}
	Object.defineProperty(n, "__esModule", {value: true}), n.extendDefaults = function (e, t) {
	  var n = undefined;
	  for (n in t) t.hasOwnProperty(n) && null !== t[n] && undefined !== t[n] && (e[n] = t[n]);
	  return e;
	  ...
	  var e = i(), t = (e.gd_sdk_referrer_url ? e.gd_sdk_referrer_url : window.location !== window.parent.location && document.referrer && "" !== document.referrer ? document.referrer.split("/")[2] : document.location.host).replace(/^(?:https?:\/\/)?(?:\/\/)?(?:www\.)?/i, "").split("/")[0];
	  if (-1 !== document.referrer.indexOf("gameplayer.io")) {
	  ...
	  return new Promise(function (n, o) {
		if (Array.from(document.querySelectorAll("script")).map(function (e) {
		  ...
		  r.type = "text/javascript", r.async = true, r.src = e, r.id = t, r.onload = function () {
			n();
		  }, r.onerror = function () {
			o("Failed to load " + e);
		  }, i.parentNode.insertBefore(r, i);
