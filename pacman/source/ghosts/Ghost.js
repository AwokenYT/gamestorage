...
export default class Ghost {
  ...
  isEnteringPen() {
    return (
      this.mode === "eyes" &&
      this.board.equalTiles(this.tile, this.board.eyesTarget)
    );
  }
  ...
  dontSwitch(mode) {
    return (
      (this.level.isFrighten(mode) && !this.level.isFrighten(this.mode)) ||
      this.mode === "eyes"
    );
  }
  ...
  draw() {
    ...
    this.ctx.save();
    this.ctx.translate(
      Math.round(this.x) - center,
      Math.round(this.y) - center
    );
  ...
  ghostNormalFace() {
    ...
    this.ctx.beginPath();
    this.ctx.arc(
      nums.n6 + this.dir.x * nums.n2,
      nums.n7 + this.dir.y * nums.n2,
      nums.r1,
      0,
      2 * Math.PI
    );
    this.ctx.arc(
      nums.n12 + this.dir.x * nums.n2,
      nums.n7 + this.dir.y * nums.n2,
      nums.r1,
      0,
      2 * Math.PI
    ...
    this.ctx.beginPath();
    this.ctx.arc(
      nums.n6 + this.dir.x * nums.n4,
      nums.n7 + this.dir.y * nums.n4,
      nums.r2,
      0,
      2 * Math.PI
    );
    this.ctx.arc(
      nums.n12 + this.dir.x * nums.n4,
      nums.n7 + this.dir.y * nums.n4,
      nums.r2,
      0,
      2 * Math.PI
